 ...
 */
class PercentToStringTransformer extends BaseValueTransformer
{
  ...
  public function transform($value)
  {
    ...
    if (self::INTEGER == $this->getOption('type'))
    {
      $value /= 100;
    }
    ...
    // replace the weird spaces output by the formatter
  ...
  {
    $formatter = new \NumberFormatter($this->getOption('locale'), \NumberFormatter::PERCENT);
