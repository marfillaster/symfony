...
/**
 * ValidatorErrorSchema represents a validation schema error.
 *
 * @package    symfony
 * @subpackage validator
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @author     Florian Eckerstorfer <florian@eckerstorfer.org> 
 * @version    SVN: $Id: ValidatorErrorSchema.php 159 2010-01-24 12:06:04Z flo $
 */
class ValidatorErrorSchema extends ValidatorError implements \ArrayAccess, \Iterator, \Countable
{
   ...
   * Adds an error.
   *
   * This method merges ValidatorErrorSchema errors with the current instance.
   *
  ...
  public function addError(ValidatorError $error, $name = null)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          $this->namedErrors[$name] = new ValidatorErrorSchema();
          $this->errors[$name] = new ValidatorErrorSchema();
        }
   ...
   *
   * @param array $errors  An array of ValidatorError instances
   *
   * @return ValidatorErrorSchema The current error schema instance
   */
   ...
   *
   * @return array An array of ValidatorError instances
   */
